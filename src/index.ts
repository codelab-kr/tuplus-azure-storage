...
if (!STORAGE_ACCOUNT_NAME) throw Error('Azure Storage STORAGE_ACCOUNT_NAME not found');
if (!STORAGE_ACCESS_KEY) throw Error('Azure Storage STORAGE_ACCESS_KEY not found');
